...
bashgit clone https://github.com/your-username/Fortress.git
cd Fortress
...
We use Conventional Commits. This keeps the history clean and makes it easy to understand what changed and why.
Format:
...
Minimal and simple emoji usage
