...
impl BenchmarkResults {
    ...
    pub fn new(
        data_size: usize,
        encrypt_time: std::time::Duration,
    ...
    pub fn print_detailed(&self, algorithm_name: &str) {
        ...
        println!(
            "  📈 Combined throughput: {}",
            BenchmarkResults::format_throughput(
...
impl AegisBenchmark {
    ...
    pub fn run_concurrent_benchmark(&self, threads: usize, data_size: usize, iterations: usize) {
        ...
        println!(
            "  Avg encryption: {}",
            format_duration(total_encrypt_time.as_nanos() / operations as u128)
        );
        println!(
            "  Avg decryption: {}",
            format_duration(total_decrypt_time.as_nanos() / operations as u128)
        );
    }
}
