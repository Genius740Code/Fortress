...
mod performance_tests {
    ...
    fn benchmark_schnorr_proof_generation() {
        ...
        println!("Schnorr proof generation ({} iterations): {:?}", iterations, generation_duration);
        println!("Schnorr proof verification ({} iterations): {:?}", iterations, verification_duration);
    ...
    fn benchmark_access_control_proofs() {
        ...
        let mut proofs = Vec::new();
        for _ in 0..iterations {
            proofs.push(AccessControlProof::create_proof(&user_key, resource_policy, permissions).unwrap());
        }
        let generation_duration = start.elapsed();
        ...
        println!("Access control proof generation ({} iterations): {:?}", iterations, generation_duration);
        println!("Access control proof verification ({} iterations): {:?}", iterations, verification_duration);
    ...
    fn benchmark_anonymous_authentication() {
        ...
        println!("Anonymous auth proof generation ({} iterations): {:?}", iterations, generation_duration);
        println!("Anonymous auth proof verification ({} iterations): {:?}", iterations, verification_duration);
...
mod integration_tests {
    ...
    fn test_multi_proof_workflow() {
        ...
        let permissions = b"read,write,admin";
        let access_proof = AccessControlProof::create_proof(&user_key, resource_policy, permissions).unwrap();
    ...
    fn test_security_level_consistency() {
        ...
        for level in [SecurityLevel::Level128, SecurityLevel::Level192, SecurityLevel::Level256] {
