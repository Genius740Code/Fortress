...
mod tests {
    ...
    use fortress_core::audit::{
        ...
        DefaultAuditLogger, EventOutcome, IntegrityReport, SecurityLevel,
    };
    use fortress_core::audit_analysis::{
        AnomalyType, AuditAnalyzer, ReportGenerator, SecurityAnomaly, SecurityInsights,
        SecurityReport,
    };
    ...
    use fortress_core::storage::{InMemoryStorage, StorageBackend, StorageConfig};
    ...
    fn test_audit_with_encryption_integration() {
        ...
        let key_manager =
            Box::new(fortress_core::key::InMemoryKeyManager::new()) as Box<dyn KeyManager>;
    ...
    fn test_audit_integrity_verification() {
        ...
        assert_eq!(
            integrity_report.valid_entries,
            integrity_report.total_entries
        );
    ...
    fn test_audit_concurrent_operations() {
        ...
        let audit_logger = Arc::new(Mutex::new(DefaultAuditLogger::new(config).unwrap()));
    ...
    fn test_audit_performance_integration() {
        ...
        println!(
            "Analyzed {} entries in {:?}",
            insights.total_entries, analysis_time
        );
    ...
    fn test_audit_memory_integration() {
        ...
        println!(
            "Memory increase for 5k entries with large metadata: {} bytes",
            memory_increase
        );
