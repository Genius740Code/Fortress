//! End-to-End Integration Tests for Fortress (Working Version)
//!
...
async fn test_encryption_workflow_with_key_rotation() -> Result<()> {
    ...
    ctx.storage.put(&audit_key, serde_json::to_string(&key_creation_event).as_bytes()).await?;
    ...
    ctx.storage.put(&encryption_audit_key, serde_json::to_string(&encryption_event).as_bytes()).await?;
    ...
    ctx.storage.put(&decryption_audit_key, serde_json::to_string(&decryption_event).as_bytes()).await?;
    ...
    ctx.storage.put(&rotation_audit_key, serde_json::to_string(&rotation_event).as_bytes()).await?;
    ...
    ctx.storage.put(&re_encryption_audit_key, serde_json::to_string(&re_encryption_event).as_bytes()).await?;
    ...
    ctx.storage.put(&verification_audit_key, serde_json::to_string(&verification_event).as_bytes()).await?;
    ...
    ctx.storage.put(&disposal_audit_key, serde_json::to_string(&disposal_event).as_bytes()).await?;
...
async fn test_concurrent_encryption_performance() -> Result<()> {
    ...
    ctx.storage.put(&performance_audit_key, serde_json::to_vec(&performance_event).unwrap()).await?;
...
async fn test_comprehensive_integration_suite() -> Result<()> {
    ...
    ctx.storage.put(&suite_audit_key, serde_json::to_vec(&suite_results_event).unwrap()).await?;
